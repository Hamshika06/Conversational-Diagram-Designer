...
Mermaid and PlantUML both have browser-only library options, rejected
here for correctness reasons (the CheerpJ-based PlantUML library
...
comparing metrics. Results are saved to JSON.
